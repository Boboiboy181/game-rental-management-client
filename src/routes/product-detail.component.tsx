...
import RentalDayListComponent from '../components/rental-day-list.component.tsx';
...
const ProductDetail = () => {
  ...
  return (
    <div className="pt-16 pl-14 pr-14 pb-24 flex flex-col justify-center items-center">
        ...
        <div className="flex items-center">
          ...
          <div className="w-[60%] product-information px-10">
            ...
            <div className="text-center cursor-pointer bg-yellow-100 mt-4 rounded-lg p-4 text-indigo-700 hover:bg-yellow-200">
              ...
              <a
                href="tel:+84374756491"
                className="mt-2 block text-xl relative"
              >
                Hotline: 0374756491
